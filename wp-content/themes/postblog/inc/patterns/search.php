...
return array(
	'title'      => __( 'Search', 'postblog' ),
	'categories' => array( 'postblog-basic' ),
	'content'    => '<!-- wp:group {"metadata":{"categories":["postblog-basic"],"patternName":"postblog/search","name":"Search"},"style":{"spacing":{"padding":{"top":"70px","bottom":"70px","left":"15px","right":"15px"}}},"backgroundColor":"postblog-dark-primary","layout":{"wideSize":"","contentSize":"","type":"constrained"}} -->
<div class="wp-block-group has-postblog-dark-primary-background-color has-background" style="padding-top:70px;padding-right:15px;padding-bottom:70px;padding-left:15px"><!-- wp:columns {"isStackedOnMobile":false} -->
<div class="wp-block-columns is-not-stacked-on-mobile"><!-- wp:column {"width":"70%"} -->
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:query {"queryId":33,"query":{"perPage":10,"pages":"","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false}} -->
