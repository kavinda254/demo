 ...
 */
return array(
	'title'      => __( 'Archive Template', 'postblog' ),
	'categories' => array( 'postblog-basic' ),
	'content'    => '<!-- wp:group {"tagName":"main","metadata":{"categories":["postblog-basic"],"patternName":"postblog/archive-template","name":"Archive Template"},"style":{"border":{"top":{"color":"var:preset|color|background-alt","width":"0px","style":"none"},"right":{"style":"none","width":"0px"},"bottom":{"color":"var:preset|color|background-alt","width":"0px","style":"none"},"left":{"style":"none","width":"0px"}}},"backgroundColor":"postblog-dark-primary","layout":{"type":"constrained","contentSize":"100%"}} -->
<main class="wp-block-group has-postblog-dark-primary-background-color has-background" style="border-top-color:var(--wp--preset--color--background-alt);border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-color:var(--wp--preset--color--background-alt);border-bottom-style:none;border-bottom-width:0px;border-left-style:none;border-left-width:0px"><!-- wp:group {"style":{"spacing":{"padding":{"left":"var:preset|spacing|40","right":"var:preset|spacing|40","top":"70px","bottom":"70px"}}},"layout":{"type":"constrained","contentSize":""}} -->
<div class="wp-block-group" style="padding-top:70px;padding-right:var(--wp--preset--spacing--40);padding-bottom:70px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"30px","left":"30px"}}}} -->
<div class="wp-block-columns"><!-- wp:column {"width":"70%"} -->
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:query {"queryId":33,"query":{"perPage":10,"pages":"","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"className":"postblog-list-post"} -->
...
<!-- wp:query-pagination {"paginationArrow":"arrow","showLabel":false,"fontFamily":"Inter","layout":{"type":"flex","justifyContent":"center","orientation":"horizontal"}} -->
