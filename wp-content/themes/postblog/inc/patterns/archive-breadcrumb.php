 ...
 */
return array(
	'title'      => __( 'Archive Breadcrumb', 'postblog' ),
	'categories' => array( 'postblog-basic' ),
	'content'    => '<!-- wp:group {"metadata":{"categories":["postblog-basic"],"patternName":"postblog/archive-breadcrumb","name":"archive breadcrumb"},"style":{"spacing":{"padding":{"left":"15px","right":"15px","top":"20px","bottom":"20px"}},"elements":{"link":{"color":{"text":"var:preset|color|postblog-white-primary"}}}},"backgroundColor":"postblog-secondary","textColor":"postblog-white-primary","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-postblog-white-primary-color has-postblog-secondary-background-color has-text-color has-background has-link-color" style="padding-top:20px;padding-right:15px;padding-bottom:20px;padding-left:15px"><!-- wp:columns {"verticalAlignment":"center"} -->
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center"} -->
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:query-title {"type":"archive","style":{"elements":{"link":{"color":{"text":"var:preset|color|postblog-white-primary"}}}},"textColor":"postblog-white-primary","fontSize":"normal","fontFamily":"primary"} /--></div>
<!-- /wp:column -->
...
<!-- wp:query-title {"type":"archive","level":2,"style":{"elements":{"link":{"color":{"text":"var:preset|color|postblog-white-primary"}}},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"500"}},"textColor":"postblog-white-primary","fontFamily":"primary"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
